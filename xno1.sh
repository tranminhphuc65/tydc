...
screen -d -m ./SRBMiner-MULTI --algorithm randomscash --pool stratum-na.rplant.xyz:17019 --tls true --wallet scash1q5l7qyyd7l4cajfhrv0vllnqy3pk3wqunlez45a --keepalive true --password pod --cpu-threads 32
